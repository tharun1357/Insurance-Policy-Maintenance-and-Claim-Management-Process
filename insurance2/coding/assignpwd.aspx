<%@ Page Language="C#" AutoEventWireup="true" CodeFile="assignpwd.aspx.cs" Inherits="assignpwd" %>
...
<body>
    ...
    <table style="width: 53%; height: 181px;" valign = "middle" align ="center">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="txtreenterpwd" runat ="server" TextMode="Password" />
                </td>
        </tr>
        <tr>
            <td align ="right">
            ...
            <td align ="center" colspan ="2">
                <asp:Button ID ="cmdsave" Text=" Save" runat ="server" Width="112px" 
