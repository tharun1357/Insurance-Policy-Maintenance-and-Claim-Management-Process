<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Customerlogin.aspx.cs" Inherits="Customerlogin" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" style="width: 384px" frame="void" bgcolor="White">
        <tr>
            <td colspan="2">
                </td>
        </tr>
        <tr>
            ...
            <asp:Label ID="lbl1" Text=" CUSTOMER LOGIN  FORM  " runat="server" Font-Bold="True" 
